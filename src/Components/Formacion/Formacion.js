  ...
  return (
    <div className="owsla bg-blue shadow">
      ...
      <FormacionCard
        ...
        descripcion="Un curso de programación FullStack donde aprendí a manejar el frontend y backend de un sistema orientado en paginas web, además de enseñarnos a trabajar con una metodología Scrum y aprender a usar herramientas verdareramente útiles como Slack | Trello | Git | Drive | Zoom y muchas mas..., el cual se realizó en su totalidad por video llamada."
      ...
      <FormacionCard
        ...
        descripcion="En 4° año de secundario elegí seguir la orientación de informatica, en la cual aprendí todo lo necesario para poder ampliar mi conocimiento en el área de programación, computación, pensamiento lógico, matemáticas y además de ayudarme a decidir mi orientacion laboral."
